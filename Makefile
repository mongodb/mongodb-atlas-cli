...
gen-api-commands: bin/api-generator ## Generate api commands
	...
	bin/api-generator --spec ./tools/cmd/api-generator/spec.yaml --overlay ./tools/cmd/api-generator/overlays --output-type commands | goimports > ./internal/api/commands.go
	bin/api-generator --spec ./tools/cmd/api-generator/spec.yaml --overlay ./tools/cmd/api-generator/overlays --output-type metadata | goimports > ./tools/cmd/docs/metadata.go
