...
sudo -y apt-get install libcurl3 libgssapi-krb5-2 \
...
replace_property_in_file "/etc/mongodb-mms/automation-agent.config" "mmsBaseUrl" "https://api-agents-dev.mongodb.com"
