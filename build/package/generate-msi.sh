...
go run ./tools/update-chocolatey-package/change-template/update-chocolatey-package.go "${VERSION}" "dist/${PACKAGE_NAME}" https://fastdl.mongodb.org/mongocli/"${PACKAGE_NAME}"
cd ./build/package/chocolatey/temp
choco pack
ls
go run ../../../../tools/update-chocolatey-package/clean-files/chocolatey-cleanup.go
