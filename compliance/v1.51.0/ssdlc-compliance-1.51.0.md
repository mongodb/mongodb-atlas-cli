SSDLC Compliance Report: Atlas CLI 1.51.0
=================================================================
...
- **Dependency Information**
  - See SBOM Lite manifests (CycloneDX in JSON format):
      - https://github.com/mongodb/mongodb-atlas-cli/releases/download/atlascli%2Fv1.51.0/sbom.json
