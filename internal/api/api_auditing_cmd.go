...
func (opts *getAuditingConfigurationOpts) run(ctx context.Context, _ io.Reader, w io.Writer) error {
...
func (opts *updateAuditingConfigurationOpts) run(ctx context.Context, r io.Reader, w io.Writer) error {
