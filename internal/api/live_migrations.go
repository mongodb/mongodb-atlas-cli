...
//go:generate mockgen -destination=../mocks/api/mock_live_migrations.go -package=mocks github.com/mongodb/mongodb-atlas-cli/internal/api LiveMigrationCreator,LiveMigrationDescriber
