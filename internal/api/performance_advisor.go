...
//go:generate mockgen -destination=../mocks/api/mock_performance_advisor.go -package=mocks github.com/mongodb/mongodb-atlas-cli/internal/api PerformanceAdvisorNamespacesLister,PerformanceAdvisorSlowQueriesLister,PerformanceAdvisorIndexesLister,PerformanceAdvisorSlowOperationThresholdEnabler,PerformanceAdvisorSlowOperationThresholdDisabler
