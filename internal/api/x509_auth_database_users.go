...
//go:generate mockgen -destination=../mocks/api/mock_x509_certificate_store.go -package=mocks github.com/mongodb/mongodb-atlas-cli/internal/api X509CertificateConfDescriber,X509CertificateConfSaver,X509CertificateConfDisabler
