...
const (
	Config             = "Manage alerts configuration for a project."
	...
	DeleteAlertsConfig = "Delete an alert configuration from a project."
	ConfigFields       = "Manage alert configuration fields for a project."
	ConfigFieldsType   = "List alert configurations available field types."
	ListConfigs        = "List alert configurations for a project."
