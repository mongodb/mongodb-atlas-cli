...
func createRootAPICommand() *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "api",
		Short: `Public Preview: please provide feedback at <https://feedback.mongodb.com/forums/930808-atlas-cli>: Access all features of the Atlas Administration API by using the Atlas CLI with the syntax: 'atlas api <tag> <operationId>'.`,
