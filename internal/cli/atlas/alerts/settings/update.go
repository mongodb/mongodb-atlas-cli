...
func UpdateBuilder() *cobra.Command {
  ...
  %s alerts settings update 5d1113b25a115342acc2d1aa --file alerts.json`, cli.ExampleAtlasEntryPoint(), cli.ExampleAtlasEntryPoint()),
	...
	cmd.MarkFlagsRequiredTogether("matcherOperator", "matcherValue", "matcherFieldName")
	...
	cmd.MarkFlagsRequiredTogether("metricOperator", "metricName", "metricMode", "metricUnits", "metricThreshold")
