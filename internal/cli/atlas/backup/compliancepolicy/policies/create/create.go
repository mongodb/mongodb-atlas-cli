...
type Opts struct {
	cli.GlobalOpts
	cli.WatchOpts
	store  store.CompliancePolicyPoliciesCreator
	fs     afero.Fs
	path   string
...
func Builder() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:     use,
		Short:   "Create the backup compliance policy for your project with a configuration file.",
		Example: example,
	...
	cmd.Flags().StringVarP(&opts.path, flag.File, flag.FileShort, "", usage.BackupComplianceCreatePolicyItemFile)
