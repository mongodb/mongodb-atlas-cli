...
func DeleteBuilder() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{
			"usernameDesc": "Username to delete from the MongoDB database. The format of the username depends on the user's method of authentication: AWS IAM method uses the ARN; x.509 and LDAP methods use the RFC 2253 Distinguished Name; SCRAM-SHA method uses an alphanumeric string.",
		},
