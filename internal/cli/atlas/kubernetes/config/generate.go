...
func GenerateBuilder() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:   "Generate kubernetes resources configuration.",
  ...
  # Export Project, DatabaseUsers resources for a specific project including connection and integrations secrets
