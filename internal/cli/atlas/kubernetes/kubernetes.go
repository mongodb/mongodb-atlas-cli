...
import (
	"github.com/andreaangiolillo/mongocli-test/internal/cli/atlas/kubernetes/config"
	"github.com/andreaangiolillo/mongocli-test/internal/cli/atlas/kubernetes/operator"
