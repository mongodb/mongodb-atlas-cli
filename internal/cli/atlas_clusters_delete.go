...
func AtlasClustersDeleteBuilder() *cobra.Command {
	...
	cmd.Flags().BoolVar(&opts.confirm, flags.Force, false, "Don't ask for confirmation")
...
// MCLI_OPS_MANAGER_URL=https://cloud-qa.mongodb.com mcli atlas clusters create test-m2 --projectId=5e18665127ed1d14c60fe85d --region US_EAST_1 --members 3 --instanceSize M2 --provider=AWS --profile qa --mdbVersion 4.2 --diskSize 2
// MCLI_OPS_MANAGER_URL=https://cloud-qa.mongodb.com mcli atlas clusters delete test-m2 --projectId=5e18665127ed1d14c60fe85d --profile qa
