...
//go:generate go tool go.uber.org/mock/mockgen -typed -destination=enable_mock_test.go -package=pointintimerestore -source=enable.go
...
type EnableOpts struct {
	...
	store             CompliancePolicyPointInTimeRestoresEnabler
