...
// Source: github.com/mongodb/mongodb-atlas-cli/atlascli/internal/cli/clusters (interfaces: LogsDownloader)
//
// Generated by this command:
//
//	mockgen -typed -destination=logs_mock_test.go -package=clusters . LogsDownloader
//
