...
//go:generate go tool go.uber.org/mock/mockgen -typed -destination=delete_mock_test.go -package=onlinearchive -source=delete.go
...
// atlas cluster(s) onlineArchive(s) delete <archiveId> [--clusterName name][--projectId projectId][--force].
