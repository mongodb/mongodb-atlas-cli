...
//go:generate go tool go.uber.org/mock/mockgen -typed -destination=region_tier_autocomplete_mock_test.go -package=clusters -source=region_tier_autocomplete.go
