...
func (opts *CreateOpts) newTeam() *opsmngr.Team {
	return &opsmngr.Team{
		Name:      opts.name,
...
func CreateBuilder() *cobra.Command {
  ...
  mongocli iam teams create myTeam --username user1@example.com,user2@example.com --orgId 5e1234c17a3e5a48f5497de3 --output json`,
