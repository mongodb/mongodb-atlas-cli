...
//go:generate go tool go.uber.org/mock/mockgen -typed -destination=create_mock_test.go -package=validation -source=create.go
...
type CreateOpts struct {
	...
	store LiveMigrationValidationsCreator
}
