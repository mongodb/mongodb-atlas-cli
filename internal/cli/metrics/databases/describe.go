...
//go:generate go tool go.uber.org/mock/mockgen -typed -destination=describe_mock_test.go -package=databases -source=describe.go
...
type DescribeOpts struct {
	...
	port  int
	name  string
	store ProcessDatabaseMeasurementsLister
}
