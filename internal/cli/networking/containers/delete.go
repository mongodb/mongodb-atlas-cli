...
//go:generate go tool go.uber.org/mock/mockgen -typed -destination=delete_mock_test.go -package=containers -source=delete.go
...
// atlas networking container(s) delete <ID> [--projectId projectId].
