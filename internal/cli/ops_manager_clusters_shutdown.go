...
type opsManagerClustersShutdownOpts struct {
	globalOpts
	name    string
	confirm bool
...
func (opts *opsManagerClustersShutdownOpts) init() error {
	if opts.ProjectID() == "" {
...
func (opts *opsManagerClustersShutdownOpts) Run() error {
	if !opts.confirm {
		return nil
	}
...
func (opts *opsManagerClustersShutdownOpts) Confirm() error {
	if opts.confirm {
		return nil
	}
...
func OpsManagerClustersShutdownBuilder() *cobra.Command {
