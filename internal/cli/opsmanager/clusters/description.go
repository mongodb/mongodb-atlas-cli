...
const (
	...
	ShutdownCluster = "Shutdown a cluster for your project."
	...
	DeleteCluster   = "Completely removes a cluster from your project."
	UnmanageCluster = "Stop managing a cluster via automation."
)
