...
//go:generate go tool go.uber.org/mock/mockgen -typed -destination=delete_mock_test.go -package=accesslists -source=delete.go
...
func DeleteBuilder() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{
			"entryDesc": "IP or CIDR address that you want to remove from the access list.",
