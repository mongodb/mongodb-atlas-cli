...
//go:generate go tool go.uber.org/mock/mockgen -typed -destination=delete_mock_test.go -package=aws -source=delete.go
...
func DeleteBuilder() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  # Remove the AWS private endpoint with the ID 5f4fc14da2b47835a58c63a2 from the project with the ID 5e2211c17a3e5a48f5497de3:
