...
//go:generate go tool go.uber.org/mock/mockgen -typed -destination=delete_mock_test.go -package=interfaces -source=delete.go
...
type DeleteOpts struct {
	...
	*cli.DeleteOpts
	...
	store                    InterfaceEndpointDeleter
}
...
// atlas privateEndpoint(s) aws interface(s) delete <endpointId> [--endpointServiceID endpointServiceID][--projectId projectId].
