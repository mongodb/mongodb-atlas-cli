...
//go:generate go tool go.uber.org/mock/mockgen -typed -destination=create_mock_test.go -package=azure -source=create.go
...
// atlas privateEndpoint(s) azure create [--region <name>] --projectId projectId.
