...
//go:generate go tool go.uber.org/mock/mockgen -typed -destination=describe_mock_test.go -package=azure -source=describe.go
...
// atlas privateEndpoint(s)|privateendpoint(s) azure describe|get <ID> [--projectId projectId].
func DescribeBuilder() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  # Return the JSON-formatted details for the Azure private endpoint connection with the ID 5f4fc81c1f03a835c2728ff7 for the project with the ID 5e2211c17a3e5a48f5497de3:
