...
//go:generate go tool go.uber.org/mock/mockgen -typed -destination=list_mock_test.go -package=azure -source=list.go
...
// atlas privateEndpoint(s)|privateendpoint(s) azure list|ls [--projectId projectId].
func ListBuilder() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Args:    require.NoArgs,
		Example: `  # Return a JSON-formatted list of all Azure private endpoints for the project with the ID 5e2211c17a3e5a48f5497de3:
