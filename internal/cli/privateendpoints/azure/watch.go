...
// atlas privateEndpoint(s) azure watch <name> [--projectId projectId].
...
` + fmt.Sprintf(usage.RequiredRole, "Project Read Only"),
		Example: `  # Watch for the Azure private endpoint with the ID 5f4fc14da2b47835a58c63a2 to become available in the project with the ID 5e2211c17a3e5a48f5497de3:
