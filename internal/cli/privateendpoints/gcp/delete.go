...
//go:generate go tool go.uber.org/mock/mockgen -typed -destination=delete_mock_test.go -package=gcp -source=delete.go
...
// atlas privateEndpoints gcp delete <privateEndpointId> [--force][--projectId projectId].
