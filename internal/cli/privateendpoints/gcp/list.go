...
//go:generate go tool go.uber.org/mock/mockgen -typed -destination=list_mock_test.go -package=gcp -source=list.go
...
// atlas privateEndpoint(s)|privateendpoint(s) gcp list|ls [--projectId projectId].
func ListBuilder() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  atlas privateEndpoint gcp ls`,
		Args:    require.NoArgs,
