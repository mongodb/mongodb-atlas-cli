...
import (
	...
	"github.com/mongodb/mongodb-atlas-cli/atlascli/internal/pluginloader"
...
`,
	...
	if commands, err := pluginloader.GetPluginCommands("./plugins"); err != nil {
	...
	if extraPluginDir != "" {
		if commands, err := pluginloader.GetPluginCommands(extraPluginDir); err != nil {
