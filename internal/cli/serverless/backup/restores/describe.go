...
func DescribeBuilder() *cobra.Command {
  ...
  atlas serverless backup restore describe --restoreJobId 507f1f77bcf86cd799439011 --clusterName Cluster0`,
		...
		Deprecated: "Command 'serverless backup restores describe' is deprecated. Please use the 'atlas backup restores describe' command instead.  For the migration guide and timeline, visit: https://dochub.mongodb.org/core/flex-migration",
	}
