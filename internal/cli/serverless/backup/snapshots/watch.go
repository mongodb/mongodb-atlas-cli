...
` + fmt.Sprintf(usage.RequiredRole, "Project Read Only"),
  ...
  atlas backups snapshots watch 5f4007f327a3bd7b6f4103c5 --clusterName myDemo`,
		...
		Deprecated: "Command 'serverless backup snapshots watch' is deprecated. Please use the 'atlas backup snapshots watch' command instead.  For the migration guide and timeline, visit: https://dochub.mongodb.org/core/flex-migration",
	}
