...
// Source: github.com/mongodb/atlas-cli-core/config (interfaces: Store,SecureStore)
//
// Generated by this command:
//
//	mockgen -destination=./mocks.go -package=config github.com/mongodb/atlas-cli-core/config Store,SecureStore
//
