...
func (kc *Client) GetSymmetricKey(keyID string) ([]byte, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("%w: %s", ErrKMIPGetOpFailure, err.Error())
	}

	var response GetResponse
	err = decoder.DecodeValue(&response, batchItem.ResponsePayload.(ttlv.TTLV))
	if err != nil {
		return nil, fmt.Errorf("%w: %s", ErrKMIPDecodeFailure, err.Error())
	}
...
func (kc *Client) CreateSymmetricKey(length int32) (*string, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("%w: %v", ErrKMIPPerformCreateSymmetricKey, err.Error())
	}

	var response CreateResponse
	err = decoder.DecodeValue(&response, batchItem.ResponsePayload.(ttlv.TTLV))
	if err != nil {
		return nil, fmt.Errorf("%w: %v", ErrKMIPDecodeCreateSymmetricKey, err.Error())
	}
...
func (kc *Client) Encrypt(keyID string, data []byte) (*EncryptResponse, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("%w: %v", ErrKMIPPerformEncrypt, err.Error())
	}

	var response EncryptResponse
	err = decoder.DecodeValue(&response, batchItem.ResponsePayload.(ttlv.TTLV))
	if err != nil {
		return nil, fmt.Errorf("%w: %v", ErrKMIPDecodeEncrypt, err.Error())
	}
...
func (kc *Client) Decrypt(keyID string, data, iv []byte) (*DecryptResponse, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("%w: %s", ErrKMIPPerformDecrypt, err.Error())
	}

	var response DecryptResponse
	err = decoder.DecodeValue(&response, batchItem.ResponsePayload.(ttlv.TTLV))
	if err != nil {
		return nil, fmt.Errorf("%w: %s", ErrKMIPDecodeDecrypt, err.Error())
	}
