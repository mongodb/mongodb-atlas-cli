...
const (
	...
	DeleteOrganizationsAPIKey   = "Delete an Organization API Key."
	ListWhitelistAPIKeys        = "Get all whitelist entries for a given API key."
	...
	ProjectOrganizationsAPIKey  = "Update an API Key for a project."
	CreateProjectAPIKey         = "Create an API Key for a project."
	DeleteProjectAPIKey         = "Delete an API Key for a project."
