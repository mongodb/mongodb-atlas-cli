...
const (
	...
	NotificationsEmailEnabled        = "notificationEmailEnabled"        // NotificationsEmailEnabled flag
	NotificationsFlowName            = "notificationFlowName"            // NotificationsFlowName flag
	NotificationsIntervalMin         = "notificationIntervalMin"         // NotificationsIntervalMin flag
	NotificationsMobileNumber        = "notificationMobileNumber"        // NotificationsMobileNumber flag
