...
//go:generate mockgen -destination=../../../mocks/mock_atlas_operator_crd_provider.go -package=mocks github.com/mongodb/mongodb-atlas-cli/internal/kubernetes/operator/crds AtlasOperatorCRDProvider
