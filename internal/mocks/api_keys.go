...
// Source: github.com/mongodb/mongocli/internal/store (interfaces: ProjectAPIKeyLister,ProjectAPIKeyCreator,OrganizationAPIKeyLister,OrganizationAPIKeyDescriber,OrganizationAPIKeyUpdater,OrganizationAPIKeyCreator,OrganizationAPIKeyDeleter,ProjectAPIKeyDeleter,ProjectAPIKeyUpdater)
...
// MockProjectAPIKeyUpdater is a mock of ProjectAPIKeyUpdater interface
type MockProjectAPIKeyUpdater struct {
	ctrl     *gomock.Controller
	recorder *MockProjectAPIKeyUpdaterMockRecorder
}

// MockProjectAPIKeyUpdaterMockRecorder is the mock recorder for MockProjectAPIKeyUpdater
type MockProjectAPIKeyUpdaterMockRecorder struct {
	mock *MockProjectAPIKeyUpdater
}

// NewMockProjectAPIKeyUpdater creates a new mock instance
func NewMockProjectAPIKeyUpdater(ctrl *gomock.Controller) *MockProjectAPIKeyUpdater {
	mock := &MockProjectAPIKeyUpdater{ctrl: ctrl}
	mock.recorder = &MockProjectAPIKeyUpdaterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockProjectAPIKeyUpdater) EXPECT() *MockProjectAPIKeyUpdaterMockRecorder {
	return m.recorder
}

// UpdateProjectAPIKey mocks base method
func (m *MockProjectAPIKeyUpdater) UpdateProjectAPIKey(arg0, arg1 string, arg2 *mongodbatlas.AssignAPIKey) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateProjectAPIKey", arg0, arg1, arg2)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateProjectAPIKey indicates an expected call of UpdateProjectAPIKey
func (mr *MockProjectAPIKeyUpdaterMockRecorder) UpdateProjectAPIKey(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateProjectAPIKey", reflect.TypeOf((*MockProjectAPIKeyUpdater)(nil).UpdateProjectAPIKey), arg0, arg1, arg2)
}
