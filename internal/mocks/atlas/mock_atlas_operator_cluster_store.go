...
// Source: github.com/mongodb/mongodb-atlas-cli/atlascli/internal/store/atlas (interfaces: OperatorClusterStore)
...
func (m *MockOperatorClusterStore) ProjectClusters(arg0 string, arg1 *atlas.ListOptions) (*admin.PaginatedAdvancedClusterDescription, error) {
	m.ctrl.T.Helper()
