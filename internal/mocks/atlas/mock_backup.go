...
// Source: github.com/mongodb/mongodb-atlas-cli/internal/store/atlas (interfaces: CompliancePolicyDescriber,CompliancePolicy,EnableEncryptionAtRestStore,CompliancePolicyPoliciesCreator)
...
// MockCompliancePolicyPoliciesCreator is a mock of CompliancePolicyPoliciesCreator interface.
type MockCompliancePolicyPoliciesCreator struct {
	ctrl     *gomock.Controller
	recorder *MockCompliancePolicyPoliciesCreatorMockRecorder
}

// MockCompliancePolicyPoliciesCreatorMockRecorder is the mock recorder for MockCompliancePolicyPoliciesCreator.
type MockCompliancePolicyPoliciesCreatorMockRecorder struct {
	mock *MockCompliancePolicyPoliciesCreator
}

// NewMockCompliancePolicyPoliciesCreator creates a new mock instance.
func NewMockCompliancePolicyPoliciesCreator(ctrl *gomock.Controller) *MockCompliancePolicyPoliciesCreator {
	mock := &MockCompliancePolicyPoliciesCreator{ctrl: ctrl}
	mock.recorder = &MockCompliancePolicyPoliciesCreatorMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockCompliancePolicyPoliciesCreator) EXPECT() *MockCompliancePolicyPoliciesCreatorMockRecorder {
	return m.recorder
}

// CreatePolicyItem mocks base method.
func (m *MockCompliancePolicyPoliciesCreator) CreatePolicyItem(arg0 string, arg1 *admin.DiskBackupApiPolicyItem) (*admin.DataProtectionSettings, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreatePolicyItem", arg0, arg1)
	ret0, _ := ret[0].(*admin.DataProtectionSettings)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreatePolicyItem indicates an expected call of CreatePolicyItem.
func (mr *MockCompliancePolicyPoliciesCreatorMockRecorder) CreatePolicyItem(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreatePolicyItem", reflect.TypeOf((*MockCompliancePolicyPoliciesCreator)(nil).CreatePolicyItem), arg0, arg1)
}

// DescribeCompliancePolicy mocks base method.
func (m *MockCompliancePolicyPoliciesCreator) DescribeCompliancePolicy(arg0 string) (*admin.DataProtectionSettings, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DescribeCompliancePolicy", arg0)
	ret0, _ := ret[0].(*admin.DataProtectionSettings)
	ret1, _ := ret[1].(error)
...
// DescribeCompliancePolicy indicates an expected call of DescribeCompliancePolicy.
func (mr *MockCompliancePolicyPoliciesCreatorMockRecorder) DescribeCompliancePolicy(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DescribeCompliancePolicy", reflect.TypeOf((*MockCompliancePolicyPoliciesCreator)(nil).DescribeCompliancePolicy), arg0)
}

// Projects mocks base method.
func (m *MockCompliancePolicyPoliciesCreator) Projects(arg0 *mongodbatlas.ListOptions) (*admin.PaginatedAtlasGroup, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCompliancePolicyPoliciesCreatorMockRecorder) Projects(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Projects", reflect.TypeOf((*MockCompliancePolicyPoliciesCreator)(nil).Projects), arg0)
}
