...
// Source: github.com/mongodb/mongodb-atlas-cli/internal/store/atlas (interfaces: CompliancePolicyDescriber,CompliancePolicy,CompliancePolicyEncryptionAtRestUpdater)
...
// MockCompliancePolicyEncryptionAtRestUpdater is a mock of CompliancePolicyEncryptionAtRestUpdater interface.
type MockCompliancePolicyEncryptionAtRestUpdater struct {
	ctrl     *gomock.Controller
	recorder *MockCompliancePolicyEncryptionAtRestUpdaterMockRecorder
}

// MockCompliancePolicyEncryptionAtRestUpdaterMockRecorder is the mock recorder for MockCompliancePolicyEncryptionAtRestUpdater.
type MockCompliancePolicyEncryptionAtRestUpdaterMockRecorder struct {
	mock *MockCompliancePolicyEncryptionAtRestUpdater
}

// NewMockCompliancePolicyEncryptionAtRestUpdater creates a new mock instance.
func NewMockCompliancePolicyEncryptionAtRestUpdater(ctrl *gomock.Controller) *MockCompliancePolicyEncryptionAtRestUpdater {
	mock := &MockCompliancePolicyEncryptionAtRestUpdater{ctrl: ctrl}
	mock.recorder = &MockCompliancePolicyEncryptionAtRestUpdaterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockCompliancePolicyEncryptionAtRestUpdater) EXPECT() *MockCompliancePolicyEncryptionAtRestUpdaterMockRecorder {
	return m.recorder
}

// UpdateEncryptionAtRest mocks base method.
func (m *MockCompliancePolicyEncryptionAtRestUpdater) UpdateEncryptionAtRest(arg0 string, arg1 bool) (*admin.DataProtectionSettings, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateEncryptionAtRest", arg0, arg1)
	ret0, _ := ret[0].(*admin.DataProtectionSettings)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UpdateEncryptionAtRest indicates an expected call of UpdateEncryptionAtRest.
func (mr *MockCompliancePolicyEncryptionAtRestUpdaterMockRecorder) UpdateEncryptionAtRest(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateEncryptionAtRest", reflect.TypeOf((*MockCompliancePolicyEncryptionAtRestUpdater)(nil).UpdateEncryptionAtRest), arg0, arg1)
}
