...
// Source: github.com/mongodb/mongodb-atlas-cli/internal/store/atlas (interfaces: CompliancePolicyDescriber,CompliancePolicy,CompliancePolicyItemUpdater)
...
// MockCompliancePolicyItemUpdater is a mock of CompliancePolicyItemUpdater interface.
type MockCompliancePolicyItemUpdater struct {
	ctrl     *gomock.Controller
	recorder *MockCompliancePolicyItemUpdaterMockRecorder
}

// MockCompliancePolicyItemUpdaterMockRecorder is the mock recorder for MockCompliancePolicyItemUpdater.
type MockCompliancePolicyItemUpdaterMockRecorder struct {
	mock *MockCompliancePolicyItemUpdater
}

// NewMockCompliancePolicyItemUpdater creates a new mock instance.
func NewMockCompliancePolicyItemUpdater(ctrl *gomock.Controller) *MockCompliancePolicyItemUpdater {
	mock := &MockCompliancePolicyItemUpdater{ctrl: ctrl}
	mock.recorder = &MockCompliancePolicyItemUpdaterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockCompliancePolicyItemUpdater) EXPECT() *MockCompliancePolicyItemUpdaterMockRecorder {
	return m.recorder
}

// UpdatePolicyItem mocks base method.
func (m *MockCompliancePolicyItemUpdater) UpdatePolicyItem(arg0 string, arg1 *admin.DiskBackupApiPolicyItem) (*admin.DataProtectionSettings, *http.Response, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCompliancePolicyItemUpdaterMockRecorder) UpdatePolicyItem(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdatePolicyItem", reflect.TypeOf((*MockCompliancePolicyItemUpdater)(nil).UpdatePolicyItem), arg0, arg1)
}
