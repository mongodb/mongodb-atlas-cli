...
// MockCompliancePolicyOnDemandPolicyDeleter is a mock of CompliancePolicyOnDemandPolicyDeleter interface.
type MockCompliancePolicyOnDemandPolicyDeleter struct {
	ctrl     *gomock.Controller
	recorder *MockCompliancePolicyOnDemandPolicyDeleterMockRecorder
}

// MockCompliancePolicyOnDemandPolicyDeleterMockRecorder is the mock recorder for MockCompliancePolicyOnDemandPolicyDeleter.
type MockCompliancePolicyOnDemandPolicyDeleterMockRecorder struct {
	mock *MockCompliancePolicyOnDemandPolicyDeleter
}

// NewMockCompliancePolicyOnDemandPolicyDeleter creates a new mock instance.
func NewMockCompliancePolicyOnDemandPolicyDeleter(ctrl *gomock.Controller) *MockCompliancePolicyOnDemandPolicyDeleter {
	mock := &MockCompliancePolicyOnDemandPolicyDeleter{ctrl: ctrl}
	mock.recorder = &MockCompliancePolicyOnDemandPolicyDeleterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockCompliancePolicyOnDemandPolicyDeleter) EXPECT() *MockCompliancePolicyOnDemandPolicyDeleterMockRecorder {
	return m.recorder
}

// DeleteOnDemandPolicy mocks base method.
func (m *MockCompliancePolicyOnDemandPolicyDeleter) DeleteOnDemandPolicy(arg0 string) (*admin.DataProtectionSettings20231001, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteOnDemandPolicy", arg0)
	ret0, _ := ret[0].(*admin.DataProtectionSettings20231001)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// DeleteOnDemandPolicy indicates an expected call of DeleteOnDemandPolicy.
func (mr *MockCompliancePolicyOnDemandPolicyDeleterMockRecorder) DeleteOnDemandPolicy(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteOnDemandPolicy", reflect.TypeOf((*MockCompliancePolicyOnDemandPolicyDeleter)(nil).DeleteOnDemandPolicy), arg0)
}

// DescribeCompliancePolicy mocks base method.
func (m *MockCompliancePolicyOnDemandPolicyDeleter) DescribeCompliancePolicy(arg0 string) (*admin.DataProtectionSettings20231001, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DescribeCompliancePolicy", arg0)
	ret0, _ := ret[0].(*admin.DataProtectionSettings20231001)
	ret1, _ := ret[1].(error)
...
// DescribeCompliancePolicy indicates an expected call of DescribeCompliancePolicy.
func (mr *MockCompliancePolicyOnDemandPolicyDeleterMockRecorder) DescribeCompliancePolicy(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DescribeCompliancePolicy", reflect.TypeOf((*MockCompliancePolicyOnDemandPolicyDeleter)(nil).DescribeCompliancePolicy), arg0)
}
