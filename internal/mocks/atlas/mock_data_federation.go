...
// Source: github.com/andreaangiolillo/mongocli-test/internal/store/atlas (interfaces: DataFederationLister,DataFederationDescriber,DataFederationStore,DataFederationCreator,DataFederationUpdater,DataFederationDeleter,DataFederationLogDownloader)
