...
// Source: github.com/andreaangiolillo/mongocli-test/internal/store/atlas (interfaces: OrganizationLister,OrganizationDeleter,OrganizationDescriber,OrganizationCreator)
