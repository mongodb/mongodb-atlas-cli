...
// Agents mocks base method
func (m *MockAgentStore) Agents(arg0, arg1 string) (*opsmngr.Agents, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Agents", arg0, arg1)
	ret0, _ := ret[0].(*opsmngr.Agents)
	ret1, _ := ret[1].(error)
...
// Agents indicates an expected call of Agents
func (mr *MockAgentStoreMockRecorder) Agents(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Agents", reflect.TypeOf((*MockAgentStore)(nil).Agents), arg0, arg1)
}
