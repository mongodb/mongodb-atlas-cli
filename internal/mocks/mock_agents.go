...
// Source: github.com/mongodb/mongocli/internal/store (interfaces: AgentLister,AgentUpgrader,AgentAPIKeyLister,AgentAPIKeyCreator,AgentAPIKeyDeleter,AgentVersionsLister,AgentProjectVersionsLister)
...
// MockAgentVersionsLister is a mock of AgentVersionsLister interface
type MockAgentVersionsLister struct {
	ctrl     *gomock.Controller
	recorder *MockAgentVersionsListerMockRecorder
}

// MockAgentVersionsListerMockRecorder is the mock recorder for MockAgentVersionsLister
type MockAgentVersionsListerMockRecorder struct {
	mock *MockAgentVersionsLister
}

// NewMockAgentVersionsLister creates a new mock instance
func NewMockAgentVersionsLister(ctrl *gomock.Controller) *MockAgentVersionsLister {
	mock := &MockAgentVersionsLister{ctrl: ctrl}
	mock.recorder = &MockAgentVersionsListerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockAgentVersionsLister) EXPECT() *MockAgentVersionsListerMockRecorder {
	return m.recorder
}

// AgentVersions mocks base method
func (m *MockAgentVersionsLister) AgentVersions() (*opsmngr.SoftwareVersions, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AgentVersions")
	ret0, _ := ret[0].(*opsmngr.SoftwareVersions)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// AgentVersions indicates an expected call of AgentVersions
func (mr *MockAgentVersionsListerMockRecorder) AgentVersions() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AgentVersions", reflect.TypeOf((*MockAgentVersionsLister)(nil).AgentVersions))
}
