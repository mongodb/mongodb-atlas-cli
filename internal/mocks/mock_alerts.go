...
//
//	mockgen -destination=../mocks/mock_alerts.go -package=mocks github.com/mongodb/mongodb-atlas-cli/atlascli/internal/store AlertDescriber,AlertLister,AlertAcknowledger
//
...
func (mr *MockAlertDescriberMockRecorder) Alert(arg0 any) *gomock.Call {
...
func (mr *MockAlertListerMockRecorder) Alerts(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAlertAcknowledgerMockRecorder) AcknowledgeAlert(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
