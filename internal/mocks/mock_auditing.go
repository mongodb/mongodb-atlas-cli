...
// Source: github.com/mongodb/mongodb-atlas-cli/internal/store (interfaces: AuditingDescriber)
...
func (m *MockAuditingDescriber) Auditing(arg0 string) (*mongodbatlas.Auditing, error) {
	m.ctrl.T.Helper()
