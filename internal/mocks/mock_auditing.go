...
//
//	mockgen -destination=../mocks/mock_auditing.go -package=mocks github.com/mongodb/mongodb-atlas-cli/atlascli/internal/store AuditingDescriber,AuditingUpdater
//
...
func (mr *MockAuditingDescriberMockRecorder) Auditing(arg0 any) *gomock.Call {
...
func (mr *MockAuditingUpdaterMockRecorder) UpdateAuditingConfig(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
