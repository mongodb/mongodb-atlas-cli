...
// Source: github.com/mongodb/mongodb-atlas-cli/mongocli/v2/internal/store (interfaces: AutomationGetter,AutomationUpdater,AutomationStatusGetter,AutomationPatcher,CloudManagerClustersLister,CloudManagerClustersDescriber,CloudManagerClustersDeleter)
...
func (m *MockCloudManagerClustersLister) ProjectClusters(arg0 string, arg1 *mongodbatlas.ListOptions) (*opsmngr.Clusters, error) {
	m.ctrl.T.Helper()
