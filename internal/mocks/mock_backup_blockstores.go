...
// Source: github.com/mongodb/mongocli/internal/store (interfaces: BlockstoresLister,BlockstoresDescriber,BlockstoresCreater)
...
// MockBlockstoresCreater is a mock of BlockstoresCreater interface
type MockBlockstoresCreater struct {
	ctrl     *gomock.Controller
	recorder *MockBlockstoresCreaterMockRecorder
}

// MockBlockstoresCreaterMockRecorder is the mock recorder for MockBlockstoresCreater
type MockBlockstoresCreaterMockRecorder struct {
	mock *MockBlockstoresCreater
}

// NewMockBlockstoresCreater creates a new mock instance
func NewMockBlockstoresCreater(ctrl *gomock.Controller) *MockBlockstoresCreater {
	mock := &MockBlockstoresCreater{ctrl: ctrl}
	mock.recorder = &MockBlockstoresCreaterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockBlockstoresCreater) EXPECT() *MockBlockstoresCreaterMockRecorder {
	return m.recorder
}
