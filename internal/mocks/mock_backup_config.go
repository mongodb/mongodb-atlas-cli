...
// Source: github.com/mongodb/mongodb-atlas-cli/mongocli/v2/internal/store (interfaces: BackupConfigGetter,BackupConfigLister,BackupConfigUpdater)
...
func (m *MockBackupConfigLister) ListBackupConfigs(arg0 string, arg1 *opsmngr.ListOptions) (*opsmngr.BackupConfigs, error) {
	m.ctrl.T.Helper()
