...
// Source: github.com/mongodb/mongodb-atlas-cli/mongocli/v2/internal/store (interfaces: OplogsLister,OplogsDescriber,OplogsCreator,OplogsUpdater,OplogsDeleter)
...
func (m *MockOplogsLister) ListOplogs(arg0 *opsmngr.ListOptions) (*opsmngr.BackupStores, error) {
	m.ctrl.T.Helper()
