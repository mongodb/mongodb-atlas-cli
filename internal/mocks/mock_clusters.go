...
// Source: github.com/mongodb/mongocli/internal/store (interfaces: ClusterLister,AtlasClusterDescriber,OpsManagerClusterDescriber,ClusterCreator,ClusterDeleter,ClusterUpdater,AtlasClusterGetterUpdater,ClusterPauser,ClusterStarter,AtlasClusterQuickStarter,SampleDataAdder,SampleDataStatusDescriber,AtlasClusterWatcher)
...
// WatchAtlasCluster mocks base method
func (m *MockAtlasClusterQuickStarter) WatchAtlasCluster(arg0, arg1 string) (*mongodbatlas.ClusterStatus, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WatchAtlasCluster", arg0, arg1)
	ret0, _ := ret[0].(*mongodbatlas.ClusterStatus)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// WatchAtlasCluster indicates an expected call of WatchAtlasCluster
func (mr *MockAtlasClusterQuickStarterMockRecorder) WatchAtlasCluster(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WatchAtlasCluster", reflect.TypeOf((*MockAtlasClusterQuickStarter)(nil).WatchAtlasCluster), arg0, arg1)
}
...
// MockAtlasClusterWatcher is a mock of AtlasClusterWatcher interface
type MockAtlasClusterWatcher struct {
	ctrl     *gomock.Controller
	recorder *MockAtlasClusterWatcherMockRecorder
}

// MockAtlasClusterWatcherMockRecorder is the mock recorder for MockAtlasClusterWatcher
type MockAtlasClusterWatcherMockRecorder struct {
	mock *MockAtlasClusterWatcher
}

// NewMockAtlasClusterWatcher creates a new mock instance
func NewMockAtlasClusterWatcher(ctrl *gomock.Controller) *MockAtlasClusterWatcher {
	mock := &MockAtlasClusterWatcher{ctrl: ctrl}
	mock.recorder = &MockAtlasClusterWatcherMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockAtlasClusterWatcher) EXPECT() *MockAtlasClusterWatcherMockRecorder {
	return m.recorder
}

// WatchAtlasCluster mocks base method
func (m *MockAtlasClusterWatcher) WatchAtlasCluster(arg0, arg1 string) (*mongodbatlas.ClusterStatus, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WatchAtlasCluster", arg0, arg1)
	ret0, _ := ret[0].(*mongodbatlas.ClusterStatus)
	ret1, _ := ret[1].(error)
...
// WatchAtlasCluster indicates an expected call of WatchAtlasCluster
func (mr *MockAtlasClusterWatcherMockRecorder) WatchAtlasCluster(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WatchAtlasCluster", reflect.TypeOf((*MockAtlasClusterWatcher)(nil).WatchAtlasCluster), arg0, arg1)
}
