...
//
//	mockgen -destination=../mocks/mock_data_lake_pipelines_runs.go -package=mocks github.com/mongodb/mongodb-atlas-cli/atlascli/internal/store PipelineRunsLister,PipelineRunsDescriber
//
...
func (mr *MockPipelineRunsListerMockRecorder) PipelineRuns(arg0, arg1 any) *gomock.Call {
...
func (mr *MockPipelineRunsDescriberMockRecorder) PipelineRun(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
