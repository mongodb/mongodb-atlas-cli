...
// Source: github.com/andreaangiolillo/mongocli-test/internal/store (interfaces: DatabaseRoleLister,DatabaseRoleCreator,DatabaseRoleDeleter,DatabaseRoleUpdater,DatabaseRoleDescriber)
