...
// Source: github.com/andreangiolillo/mongocli-test/internal/store (interfaces: DatabaseRoleLister,DatabaseRoleCreator,DatabaseRoleDeleter,DatabaseRoleUpdater,DatabaseRoleDescriber)
