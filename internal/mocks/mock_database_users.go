...
func (m *MockDatabaseUserCreator) CreateDatabaseUser(arg0 *mongodbatlasv2.DatabaseUser) (*mongodbatlasv2.DatabaseUser, error) {
	m.ctrl.T.Helper()
...
func (m *MockDatabaseUserUpdater) UpdateDatabaseUser(arg0 *mongodbatlasv2.DatabaseUser) (*mongodbatlasv2.DatabaseUser, error) {
	m.ctrl.T.Helper()
