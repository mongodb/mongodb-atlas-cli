...
// Source: github.com/andreangiolillo/mongocli-test/internal/store (interfaces: GlobalAPIKeyLister,GlobalAPIKeyDescriber,GlobalAPIKeyUpdater,GlobalAPIKeyCreator,GlobalAPIKeyDeleter)
