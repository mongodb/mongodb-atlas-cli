...
// Source: github.com/mongodb/mongodb-atlas-cli/internal/store (interfaces: GlobalClusterDescriber)
...
func (m *MockGlobalClusterDescriber) GlobalCluster(arg0, arg1 string) (*mongodbatlas.GlobalCluster, error) {
	m.ctrl.T.Helper()
