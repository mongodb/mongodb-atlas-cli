...
// Source: github.com/mongodb/mongodb-atlas-cli/internal/store (interfaces: IndexCreator)
...
func (m *MockIndexCreator) CreateIndex(arg0, arg1 string, arg2 *admin.RollingIndexRequest) error {
	m.ctrl.T.Helper()
