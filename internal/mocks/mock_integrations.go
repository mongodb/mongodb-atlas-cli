...
// Source: github.com/andreaangiolillo/mongocli-test/internal/store (interfaces: IntegrationCreator,IntegrationLister,IntegrationDeleter,IntegrationDescriber)
