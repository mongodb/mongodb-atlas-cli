...
// Source: github.com/andreaangiolillo/mongocli-test/internal/store (interfaces: LDAPConfigurationVerifier,LDAPConfigurationDescriber,LDAPConfigurationSaver,LDAPConfigurationDeleter,LDAPConfigurationGetter)
