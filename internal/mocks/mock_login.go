...
// Source: github.com/mongodb/mongocli/internal/cli/auth (interfaces: Authenticator,LoginConfig,RegisterFlow)
...
import (
	...
	auth "github.com/mongodb/mongocli/internal/cli/auth"
	auth0 "go.mongodb.org/atlas/auth"
...
func (m *MockAuthenticator) PollToken(arg0 context.Context, arg1 *auth0.DeviceCode) (*auth0.Token, *mongodbatlas.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PollToken", arg0, arg1)
	ret0, _ := ret[0].(*auth0.Token)
...
func (m *MockAuthenticator) RequestCode(arg0 context.Context) (*auth0.DeviceCode, *mongodbatlas.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RequestCode", arg0)
	ret0, _ := ret[0].(*auth0.DeviceCode)
	ret1, _ := ret[1].(*mongodbatlas.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockRegisterFlow) Flow(arg0 *auth.RegisterOpts) error {
	m.ctrl.T.Helper()
...
func (mr *MockRegisterFlowMockRecorder) Flow(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Flow", reflect.TypeOf((*MockRegisterFlow)(nil).Flow), arg0)
}
