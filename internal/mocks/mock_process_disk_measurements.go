...
//
//	mockgen -destination=../mocks/mock_process_disk_measurements.go -package=mocks github.com/mongodb/mongodb-atlas-cli/atlascli/internal/store ProcessDiskMeasurementsLister,ProcessDatabaseMeasurementsLister
//
...
func (mr *MockProcessDiskMeasurementsListerMockRecorder) ProcessDiskMeasurements(arg0 any) *gomock.Call {
...
func (mr *MockProcessDatabaseMeasurementsListerMockRecorder) ProcessDatabaseMeasurements(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
