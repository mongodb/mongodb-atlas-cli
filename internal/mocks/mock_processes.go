...
//
//	mockgen -destination=../mocks/mock_processes.go -package=mocks github.com/mongodb/mongodb-atlas-cli/atlascli/internal/store ProcessLister,ProcessDescriber
//
...
func (mr *MockProcessListerMockRecorder) Processes(arg0 any) *gomock.Call {
...
func (mr *MockProcessDescriberMockRecorder) Process(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
