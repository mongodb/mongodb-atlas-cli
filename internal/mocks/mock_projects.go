...
// Source: github.com/mongodb/mongodb-atlas-cli/atlascli/internal/store (interfaces: ProjectLister,ProjectCreator,ProjectDeleter,ProjectDescriber,ProjectUsersLister,ProjectUserDeleter,ProjectTeamLister,ProjectTeamAdder,ProjectTeamDeleter)
...
func (m *MockProjectLister) GetOrgProjects(arg0 string, arg1 *mongodbatlas.ProjectsListOptions) (*mongodbatlas.Projects, error) {
	m.ctrl.T.Helper()
...
func (m *MockProjectLister) Projects(arg0 *mongodbatlas.ListOptions) (*mongodbatlas.Projects, error) {
	m.ctrl.T.Helper()
...
func (m *MockProjectCreator) CreateProject(arg0, arg1, arg2 string, arg3 *bool, arg4 *mongodbatlas.CreateProjectOptions) (*mongodbatlas.Project, error) {
	m.ctrl.T.Helper()
...
func (m *MockProjectDescriber) Project(arg0 string) (*mongodbatlas.Project, error) {
	m.ctrl.T.Helper()
...
func (m *MockProjectDescriber) ProjectByName(arg0 string) (*mongodbatlas.Project, error) {
	m.ctrl.T.Helper()
...
func (m *MockProjectUsersLister) ProjectUsers(arg0 string, arg1 *mongodbatlas.ListOptions) ([]mongodbatlas.AtlasUser, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ProjectUsers", arg0, arg1)
	ret0, _ := ret[0].([]mongodbatlas.AtlasUser)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
