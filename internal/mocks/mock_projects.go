...
// Source: github.com/mongodb/mongodb-atlas-cli/mongocli/v2/internal/store (interfaces: ProjectLister,OrgProjectLister,ProjectCreator,ProjectDeleter,ProjectDescriber,ProjectUsersLister,ProjectUserDeleter,ProjectTeamLister,ProjectTeamAdder,ProjectTeamDeleter)
...
// GetOrgProjects mocks base method.
func (m *MockOrgProjectLister) GetOrgProjects(arg0 string) (*opsmngr.Projects, error) {
	m.ctrl.T.Helper()
...
func (m *MockProjectDescriber) Project(arg0 string) (*opsmngr.Project, error) {
	m.ctrl.T.Helper()
...
func (m *MockProjectDescriber) ProjectByName(arg0 string) (*opsmngr.Project, error) {
	m.ctrl.T.Helper()
