...
// Source: github.com/andreaangiolillo/mongocli-test/internal/store (interfaces: SearchIndexLister,SearchIndexCreator,SearchIndexDescriber,SearchIndexUpdater,SearchIndexDeleter)
