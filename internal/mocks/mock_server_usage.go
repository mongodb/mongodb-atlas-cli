...
// Source: github.com/mongodb/mongocli/internal/store (interfaces: ProjectServerTypeGetter,ProjectServerTypeUpdater,OrganizationServerTypeGetter,OrganizationServerTypeUpdater,ProjectHostAssignmentLister,OrganizationHostAssignmentLister,SnapshotGenerator,ReportDownloader)
...
// MockReportDownloader is a mock of ReportDownloader interface
type MockReportDownloader struct {
	ctrl     *gomock.Controller
	recorder *MockReportDownloaderMockRecorder
}

// MockReportDownloaderMockRecorder is the mock recorder for MockReportDownloader
type MockReportDownloaderMockRecorder struct {
	mock *MockReportDownloader
}

// NewMockReportDownloader creates a new mock instance
func NewMockReportDownloader(ctrl *gomock.Controller) *MockReportDownloader {
	mock := &MockReportDownloader{ctrl: ctrl}
	mock.recorder = &MockReportDownloaderMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockReportDownloader) EXPECT() *MockReportDownloaderMockRecorder {
	return m.recorder
}

// DownloadReport mocks base method
func (m *MockReportDownloader) DownloadReport(arg0 *opsmngr.ServerTypeOptions, arg1 io.Writer) error {
	m.ctrl.T.Helper()
...
func (mr *MockReportDownloaderMockRecorder) DownloadReport(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DownloadReport", reflect.TypeOf((*MockReportDownloader)(nil).DownloadReport), arg0, arg1)
}
