...
// Source: github.com/mongodb/mongodb-atlas-cli/internal/store (interfaces: ServerlessInstanceLister,ServerlessInstanceDescriber,ServerlessInstanceDeleter,ServerlessInstanceCreator,ServerlessInstanceUpdater,ServerlessInstanceDetails)
...
// MockServerlessInstanceDetails is a mock of ServerlessInstanceDetails interface.
type MockServerlessInstanceDetails struct {
	ctrl     *gomock.Controller
	recorder *MockServerlessInstanceDetailsMockRecorder
}

// MockServerlessInstanceDetailsMockRecorder is the mock recorder for MockServerlessInstanceDetails.
type MockServerlessInstanceDetailsMockRecorder struct {
	mock *MockServerlessInstanceDetails
}

// NewMockServerlessInstanceDetails creates a new mock instance.
func NewMockServerlessInstanceDetails(ctrl *gomock.Controller) *MockServerlessInstanceDetails {
	mock := &MockServerlessInstanceDetails{ctrl: ctrl}
	mock.recorder = &MockServerlessInstanceDetailsMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockServerlessInstanceDetails) EXPECT() *MockServerlessInstanceDetailsMockRecorder {
	return m.recorder
}

// ServerlessInstanceDetails mocks base method.
func (m *MockServerlessInstanceDetails) ServerlessInstanceDetails(arg0, arg1 string) (*mongodbatlasv2.ServerlessInstanceDescription, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ServerlessInstanceDetails", arg0, arg1)
	ret0, _ := ret[0].(*mongodbatlasv2.ServerlessInstanceDescription)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ServerlessInstanceDetails indicates an expected call of ServerlessInstanceDetails.
func (mr *MockServerlessInstanceDetailsMockRecorder) ServerlessInstanceDetails(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ServerlessInstanceDetails", reflect.TypeOf((*MockServerlessInstanceDetails)(nil).ServerlessInstanceDetails), arg0, arg1)
}
