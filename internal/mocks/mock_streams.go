...
//
//	mockgen -destination=../mocks/mock_streams.go -package=mocks github.com/mongodb/mongodb-atlas-cli/atlascli/internal/store StreamsLister,StreamsDescriber,StreamsCreator,StreamsDeleter,StreamsUpdater,StreamsDownloader,ConnectionCreator,ConnectionDeleter,ConnectionUpdater,StreamsConnectionDescriber,StreamsConnectionLister,PrivateLinkCreator,PrivateLinkLister,PrivateLinkDescriber,PrivateLinkDeleter
//
...
func (mr *MockStreamsListerMockRecorder) ProjectStreams(arg0 any) *gomock.Call {
...
func (mr *MockStreamsDescriberMockRecorder) AtlasStream(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsCreatorMockRecorder) CreateStream(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDeleterMockRecorder) DeleteStream(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsUpdaterMockRecorder) UpdateStream(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDownloaderMockRecorder) DownloadAuditLog(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockConnectionCreatorMockRecorder) CreateConnection(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockConnectionDeleterMockRecorder) DeleteConnection(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockConnectionUpdaterMockRecorder) UpdateConnection(arg0, arg1, arg2, arg3 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsConnectionDescriberMockRecorder) StreamConnection(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsConnectionListerMockRecorder) StreamsConnections(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// MockPrivateLinkCreator is a mock of PrivateLinkCreator interface.
type MockPrivateLinkCreator struct {
	ctrl     *gomock.Controller
	recorder *MockPrivateLinkCreatorMockRecorder
	isgomock struct{}
}

// MockPrivateLinkCreatorMockRecorder is the mock recorder for MockPrivateLinkCreator.
type MockPrivateLinkCreatorMockRecorder struct {
	mock *MockPrivateLinkCreator
}

// NewMockPrivateLinkCreator creates a new mock instance.
func NewMockPrivateLinkCreator(ctrl *gomock.Controller) *MockPrivateLinkCreator {
	mock := &MockPrivateLinkCreator{ctrl: ctrl}
	mock.recorder = &MockPrivateLinkCreatorMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockPrivateLinkCreator) EXPECT() *MockPrivateLinkCreatorMockRecorder {
	return m.recorder
}

// CreatePrivateLinkEndpoint mocks base method.
func (m *MockPrivateLinkCreator) CreatePrivateLinkEndpoint(projectID string, connection *admin.StreamsPrivateLinkConnection) (*admin.StreamsPrivateLinkConnection, error) {
	m.ctrl.T.Helper()
...
func (mr *MockPrivateLinkCreatorMockRecorder) CreatePrivateLinkEndpoint(projectID, connection any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreatePrivateLinkEndpoint", reflect.TypeOf((*MockPrivateLinkCreator)(nil).CreatePrivateLinkEndpoint), projectID, connection)
}

// MockPrivateLinkLister is a mock of PrivateLinkLister interface.
type MockPrivateLinkLister struct {
	ctrl     *gomock.Controller
	recorder *MockPrivateLinkListerMockRecorder
	isgomock struct{}
}

// MockPrivateLinkListerMockRecorder is the mock recorder for MockPrivateLinkLister.
type MockPrivateLinkListerMockRecorder struct {
	mock *MockPrivateLinkLister
}

// NewMockPrivateLinkLister creates a new mock instance.
func NewMockPrivateLinkLister(ctrl *gomock.Controller) *MockPrivateLinkLister {
	mock := &MockPrivateLinkLister{ctrl: ctrl}
	mock.recorder = &MockPrivateLinkListerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockPrivateLinkLister) EXPECT() *MockPrivateLinkListerMockRecorder {
	return m.recorder
}

// ListPrivateLinkEndpoints mocks base method.
func (m *MockPrivateLinkLister) ListPrivateLinkEndpoints(projectID string) (*admin.PaginatedApiStreamsPrivateLink, error) {
	m.ctrl.T.Helper()
...
func (mr *MockPrivateLinkListerMockRecorder) ListPrivateLinkEndpoints(projectID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListPrivateLinkEndpoints", reflect.TypeOf((*MockPrivateLinkLister)(nil).ListPrivateLinkEndpoints), projectID)
}

// MockPrivateLinkDescriber is a mock of PrivateLinkDescriber interface.
type MockPrivateLinkDescriber struct {
	ctrl     *gomock.Controller
	recorder *MockPrivateLinkDescriberMockRecorder
	isgomock struct{}
}

// MockPrivateLinkDescriberMockRecorder is the mock recorder for MockPrivateLinkDescriber.
type MockPrivateLinkDescriberMockRecorder struct {
	mock *MockPrivateLinkDescriber
}

// NewMockPrivateLinkDescriber creates a new mock instance.
func NewMockPrivateLinkDescriber(ctrl *gomock.Controller) *MockPrivateLinkDescriber {
	mock := &MockPrivateLinkDescriber{ctrl: ctrl}
	mock.recorder = &MockPrivateLinkDescriberMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockPrivateLinkDescriber) EXPECT() *MockPrivateLinkDescriberMockRecorder {
	return m.recorder
}

// DescribePrivateLinkEndpoint mocks base method.
func (m *MockPrivateLinkDescriber) DescribePrivateLinkEndpoint(projectID, connectionID string) (*admin.StreamsPrivateLinkConnection, error) {
	m.ctrl.T.Helper()
...
func (mr *MockPrivateLinkDescriberMockRecorder) DescribePrivateLinkEndpoint(projectID, connectionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DescribePrivateLinkEndpoint", reflect.TypeOf((*MockPrivateLinkDescriber)(nil).DescribePrivateLinkEndpoint), projectID, connectionID)
}

// MockPrivateLinkDeleter is a mock of PrivateLinkDeleter interface.
type MockPrivateLinkDeleter struct {
	ctrl     *gomock.Controller
	recorder *MockPrivateLinkDeleterMockRecorder
	isgomock struct{}
}

// MockPrivateLinkDeleterMockRecorder is the mock recorder for MockPrivateLinkDeleter.
type MockPrivateLinkDeleterMockRecorder struct {
	mock *MockPrivateLinkDeleter
}

// NewMockPrivateLinkDeleter creates a new mock instance.
func NewMockPrivateLinkDeleter(ctrl *gomock.Controller) *MockPrivateLinkDeleter {
	mock := &MockPrivateLinkDeleter{ctrl: ctrl}
	mock.recorder = &MockPrivateLinkDeleterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockPrivateLinkDeleter) EXPECT() *MockPrivateLinkDeleterMockRecorder {
	return m.recorder
}

// DeletePrivateLinkEndpoint mocks base method.
func (m *MockPrivateLinkDeleter) DeletePrivateLinkEndpoint(projectID, connectionID string) error {
	m.ctrl.T.Helper()
...
func (mr *MockPrivateLinkDeleterMockRecorder) DeletePrivateLinkEndpoint(projectID, connectionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeletePrivateLinkEndpoint", reflect.TypeOf((*MockPrivateLinkDeleter)(nil).DeletePrivateLinkEndpoint), projectID, connectionID)
}
