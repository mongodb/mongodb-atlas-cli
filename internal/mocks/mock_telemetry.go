...
//
//	mockgen -destination=../mocks/mock_telemetry.go -package=mocks github.com/mongodb/mongodb-atlas-cli/atlascli/internal/store EventsSender,UnauthEventsSender
//
...
func (mr *MockEventsSenderMockRecorder) SendEvents(body any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendEvents", reflect.TypeOf((*MockEventsSender)(nil).SendEvents), body)
}
...
func (mr *MockUnauthEventsSenderMockRecorder) SendUnauthEvents(body any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendUnauthEvents", reflect.TypeOf((*MockUnauthEventsSender)(nil).SendUnauthEvents), body)
}
