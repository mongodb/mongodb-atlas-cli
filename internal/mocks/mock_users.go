...
// Source: github.com/mongodb/mongodb-atlas-cli/mongocli/v2/internal/store (interfaces: UserCreator,UserDescriber,UserDeleter,UserLister,TeamUserLister)
...
func (m *MockUserLister) OrganizationUsers(arg0 string, arg1 *opsmngr.ListOptions) (*opsmngr.UsersResponse, error) {
	m.ctrl.T.Helper()
