...
// Source: github.com/mongodb/mongocli/internal/store (interfaces: VersionManifestUpdater,VersionManifestGetter,VersionManifestGetterUpdater)
...
// MockVersionManifestGetterUpdater is a mock of VersionManifestGetterUpdater interface.
type MockVersionManifestGetterUpdater struct {
	ctrl     *gomock.Controller
	recorder *MockVersionManifestGetterUpdaterMockRecorder
}

// MockVersionManifestGetterUpdaterMockRecorder is the mock recorder for MockVersionManifestGetterUpdater.
type MockVersionManifestGetterUpdaterMockRecorder struct {
	mock *MockVersionManifestGetterUpdater
}

// NewMockVersionManifestGetterUpdater creates a new mock instance.
func NewMockVersionManifestGetterUpdater(ctrl *gomock.Controller) *MockVersionManifestGetterUpdater {
	mock := &MockVersionManifestGetterUpdater{ctrl: ctrl}
	mock.recorder = &MockVersionManifestGetterUpdaterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockVersionManifestGetterUpdater) EXPECT() *MockVersionManifestGetterUpdaterMockRecorder {
	return m.recorder
}

// GetVersionManifest mocks base method.
func (m *MockVersionManifestGetterUpdater) GetVersionManifest(arg0 string) (*opsmngr.VersionManifest, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetVersionManifest", arg0)
	ret0, _ := ret[0].(*opsmngr.VersionManifest)
	ret1, _ := ret[1].(error)
...
// UpdateVersionManifest mocks base method.
func (m *MockVersionManifestGetterUpdater) UpdateVersionManifest(arg0 *opsmngr.VersionManifest) (*opsmngr.VersionManifest, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateVersionManifest", arg0)
	ret0, _ := ret[0].(*opsmngr.VersionManifest)
	ret1, _ := ret[1].(error)
...
// UpdateVersionManifest indicates an expected call of UpdateVersionManifest.
func (mr *MockVersionManifestGetterUpdaterMockRecorder) UpdateVersionManifest(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateVersionManifest", reflect.TypeOf((*MockVersionManifestGetterUpdater)(nil).UpdateVersionManifest), arg0)
}
