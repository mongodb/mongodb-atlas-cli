...
// Source: github.com/mongodb/mongodb-atlas-cli/mongocli/v2/internal/store (interfaces: VersionManifestUpdater,VersionManifestGetter,VersionManifestUpdaterServiceVersionDescriber)
...
func (m *MockVersionManifestUpdaterServiceVersionDescriber) ServiceVersion() (*opsmngr.ServiceVersion, error) {
	m.ctrl.T.Helper()
