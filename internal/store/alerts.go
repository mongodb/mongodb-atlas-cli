...
//go:generate mockgen -destination=../mocks/mock_alerts.go -package=mocks github.com/mongodb/mongodb-atlas-cli/mongocli/v2/internal/store AlertDescriber,AlertLister,AlertAcknowledger
