...
//go:generate mockgen -destination=../mocks/mock_alerts.go -package=mocks github.com/andreangiolillo/mongocli-test/internal/store AlertDescriber,AlertLister,AlertAcknowledger
