...
//go:generate mockgen -destination=../../mocks/atlas/mock_access_role.go -package=atlas github.com/mongodb/mongodb-atlas-cli/atlascli/internal/store/atlas CloudProviderAccessRoleLister
