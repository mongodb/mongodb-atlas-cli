...
//go:generate mockgen -destination=../../mocks/atlas/mock_auditing.go -package=atlas github.com/andreaangiolillo/mongocli-test/internal/store/atlas AuditingDescriber
