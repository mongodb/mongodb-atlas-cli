...
//go:generate mockgen -destination=../../mocks/atlas/mock_auditing.go -package=atlas github.com/andreangiolillo/mongocli-test/internal/store/atlas AuditingDescriber
