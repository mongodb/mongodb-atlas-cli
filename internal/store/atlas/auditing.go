...
//go:generate mockgen -destination=../../mocks/atlas/mock_auditing.go -package=atlas github.com/mongodb/mongodb-atlas-cli/internal/store/atlas AuditingDescriber
