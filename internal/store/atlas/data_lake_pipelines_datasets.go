...
//go:generate mockgen -destination=../../mocks/atlas/mock_data_lake_pipelines_datasets.go -package=atlas github.com/andreaangiolillo/mongocli-test/internal/store/atlas PipelineDatasetDeleter
