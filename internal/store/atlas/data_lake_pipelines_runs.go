...
//go:generate mockgen -destination=../../mocks/atlas/mock_data_lake_pipelines_runs.go -package=atlas github.com/mongodb/mongodb-atlas-cli/atlascli/internal/store/atlas PipelineRunsLister,PipelineRunsDescriber
