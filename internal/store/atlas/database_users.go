...
//go:generate mockgen -destination=../../mocks/atlas/mock_database_users.go -package=atlas github.com/andreaangiolillo/mongocli-test/internal/store/atlas DatabaseUserLister
