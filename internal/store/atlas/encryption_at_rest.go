...
//go:generate mockgen -destination=../../mocks/atlas/mock_encryption_at_rest.go -package=atlas github.com/andreaangiolillo/mongocli-test/internal/store/atlas EncryptionAtRestDescriber
