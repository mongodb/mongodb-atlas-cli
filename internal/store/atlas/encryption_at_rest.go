...
//go:generate mockgen -destination=../../mocks/atlas/mock_encryption_at_rest.go -package=atlas github.com/mongodb/mongodb-atlas-cli/atlascli/internal/store/atlas EncryptionAtRestDescriber
