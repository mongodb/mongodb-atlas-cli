...
//go:generate mockgen -destination=../../mocks/atlas/mock_global_cluster.go -package=atlas github.com/andreaangiolillo/mongocli-test/internal/store/atlas GlobalClusterDescriber
