...
//go:generate mockgen -destination=../../mocks/atlas/mock_integrations.go -package=atlas github.com/andreangiolillo/mongocli-test/internal/store/atlas IntegrationLister
