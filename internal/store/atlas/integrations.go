...
//go:generate mockgen -destination=../../mocks/atlas/mock_integrations.go -package=atlas github.com/andreaangiolillo/mongocli-test/internal/store/atlas IntegrationLister
