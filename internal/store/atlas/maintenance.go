...
//go:generate mockgen -destination=../../mocks/atlas/mock_maintenance.go -package=atlas github.com/mongodb/mongodb-atlas-cli/atlascli/internal/store/atlas MaintenanceWindowDescriber
