...
//go:generate mockgen -destination=../../mocks/atlas/mock_peering_connections.go -package=atlas github.com/andreaangiolillo/mongocli-test/internal/store/atlas PeeringConnectionLister
