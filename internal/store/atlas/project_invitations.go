...
//go:generate mockgen -destination=../../mocks/atlas/mock_project_invitations.go -package=atlas github.com/andreangiolillo/mongocli-test/internal/store/atlas ProjectInvitationLister,ProjectInvitationDescriber,ProjectInvitationDeleter,ProjectInviter,ProjectInvitationUpdater
