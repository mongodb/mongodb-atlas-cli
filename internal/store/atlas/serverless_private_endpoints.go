...
//go:generate mockgen -destination=../../mocks/atlas/mock_serverless_private_endpoints.go -package=atlas github.com/mongodb/mongodb-atlas-cli/atlascli/internal/store/atlas ServerlessPrivateEndpointsLister
