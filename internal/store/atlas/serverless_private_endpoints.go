...
//go:generate mockgen -destination=../../mocks/atlas/mock_serverless_private_endpoints.go -package=atlas github.com/andreangiolillo/mongocli-test/internal/store/atlas ServerlessPrivateEndpointsLister
