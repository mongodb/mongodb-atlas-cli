...
//go:generate mockgen -destination=../../mocks/atlas/mock_service_version.go -package=atlas github.com/andreaangiolillo/mongocli-test/internal/store/atlas ServiceVersionDescriber
