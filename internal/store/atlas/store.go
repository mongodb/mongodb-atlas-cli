...
//go:generate mockgen -destination=../../mocks/atlas/store.go -package=atlas github.com/mongodb/mongodb-atlas-cli/atlascli/internal/store/atlas CredentialsGetter
