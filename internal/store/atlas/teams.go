...
//go:generate mockgen -destination=../../mocks/atlas/mock_teams.go -package=atlas github.com/andreaangiolillo/mongocli-test/internal/store/atlas TeamLister,TeamDescriber,TeamCreator,TeamDeleter,TeamAdder,TeamUserRemover,TeamRolesUpdater
