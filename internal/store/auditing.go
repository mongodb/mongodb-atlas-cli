...
//go:generate mockgen -destination=../mocks/mock_auditing.go -package=mocks github.com/andreangiolillo/mongocli-test/internal/store AuditingDescriber,AuditingUpdater
