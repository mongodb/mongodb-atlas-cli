...
//go:generate mockgen -destination=../mocks/mock_auditing.go -package=mocks github.com/andreaangiolillo/mongocli-test/internal/store AuditingDescriber,AuditingUpdater
