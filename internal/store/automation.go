...
//go:generate mockgen -destination=../mocks/mock_automation.go -package=mocks github.com/andreaangiolillo/mongocli-test/internal/store AutomationGetter,AutomationUpdater,AutomationStatusGetter,AutomationPatcher,CloudManagerClustersLister,CloudManagerClustersDescriber,CloudManagerClustersDeleter
