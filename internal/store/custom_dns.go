...
//go:generate mockgen -destination=../mocks/mock_custom_dns.go -package=mocks github.com/andreangiolillo/mongocli-test/internal/store CustomDNSEnabler,CustomDNSDisabler,CustomDNSDescriber
