...
//go:generate mockgen -destination=../mocks/mock_default_mongodb_version.go -package=mocks github.com/andreangiolillo/mongocli-test/internal/store DefaultVersionGetter
