...
//go:generate mockgen -destination=../mocks/mock_default_mongodb_version.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/atlascli/internal/store DefaultVersionGetter
