...
//go:generate mockgen -destination=../mocks/mock_events.go -package=mocks github.com/andreangiolillo/mongocli-test/internal/store OrganizationEventLister,ProjectEventLister,EventLister
