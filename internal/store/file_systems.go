...
//go:generate mockgen -destination=../mocks/mock_backup_file_systems.go -package=mocks github.com/andreaangiolillo/mongocli-test/internal/store FileSystemsLister,FileSystemsDescriber,FileSystemsDeleter,FileSystemsCreator,FileSystemsUpdater
