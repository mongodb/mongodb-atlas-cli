...
//go:generate mockgen -destination=../mocks/mock_global_api_keys_access_list.go -package=mocks github.com/andreaangiolillo/mongocli-test/internal/store GlobalAPIKeyWhitelistLister,GlobalAPIKeyWhitelistDescriber,GlobalAPIKeyWhitelistCreator,GlobalAPIKeyWhitelistDeleter
