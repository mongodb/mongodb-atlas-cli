...
//go:generate mockgen -destination=../mocks/mock_global_cluster.go -package=mocks github.com/andreangiolillo/mongocli-test/internal/store GlobalClusterDescriber
