...
//go:generate mockgen -destination=../mocks/mock_live_migration_orgs_connection.go -package=mocks github.com/andreangiolillo/mongocli-test/internal/store OrganizationsConnector,OrganizationsDescriber
