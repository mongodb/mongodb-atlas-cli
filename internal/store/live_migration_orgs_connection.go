...
//go:generate mockgen -destination=../mocks/mock_live_migration_orgs_connection.go -package=mocks github.com/andreaangiolillo/mongocli-test/internal/store OrganizationsConnector,OrganizationsDescriber
