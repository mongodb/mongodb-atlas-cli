...
//go:generate mockgen -destination=../mocks/mock_live_migrations.go -package=mocks github.com/andreaangiolillo/mongocli-test/internal/store LiveMigrationCreator,LiveMigrationDescriber
