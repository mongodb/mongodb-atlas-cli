...
//go:generate mockgen -destination=../mocks/mock_live_migrations.go -package=mocks github.com/andreangiolillo/mongocli-test/internal/store LiveMigrationCreator,LiveMigrationDescriber
