...
//go:generate mockgen -destination=../mocks/mock_process_measurements.go -package=mocks github.com/andreangiolillo/mongocli-test/internal/store ProcessMeasurementLister
