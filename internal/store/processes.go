...
//go:generate mockgen -destination=../mocks/mock_processes.go -package=mocks github.com/andreangiolillo/mongocli-test/internal/store ProcessLister,ProcessDescriber
