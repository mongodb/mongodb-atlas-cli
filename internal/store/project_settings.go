...
//go:generate mockgen -destination=../mocks/mock_project_settings.go -package=mocks github.com/andreaangiolillo/mongocli-test/internal/store ProjectSettingsDescriber,ProjectSettingsUpdater
