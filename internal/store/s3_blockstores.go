...
//go:generate mockgen -destination=../mocks/mock_backup_s3_blockstores.go -package=mocks github.com/andreangiolillo/mongocli-test/internal/store S3BlockstoresLister,S3BlockstoresDeleter,S3BlockstoresCreator,S3BlockstoresUpdater,S3BlockstoresDescriber
