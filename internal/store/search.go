...
//go:generate mockgen -destination=../mocks/mock_search.go -package=mocks github.com/andreangiolillo/mongocli-test/internal/store SearchIndexLister,SearchIndexCreator,SearchIndexDescriber,SearchIndexUpdater,SearchIndexDeleter
