...
//go:generate mockgen -destination=../mocks/mock_backup_snapshot_schedule.go -package=mocks github.com/andreaangiolillo/mongocli-test/internal/store SnapshotScheduleDescriber,SnapshotScheduleUpdater
