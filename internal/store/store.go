...
type Store struct {
	...
	// Atlas Cloud OAuth Token from config
	configTokenCache sdkauth.LocalTokenCache
	client           *atlas.Client
...
func New(opts ...Option) (*Store, error) {
	...
	// This should be injected in early phases of CLI build to differentiate between digest/OAuth.
	store.configTokenCache = &config.ConfigTokenCache{}
