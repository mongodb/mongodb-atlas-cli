...
//go:generate mockgen -destination=../mocks/mock_telemetry.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/atlascli/internal/store EventsSender,UnauthEventsSender
