...
dbName and collection are required only for built-in roles.`
	...
	FederationSettingsId  = "Unique identifier of the data federation settings."
	IdpType               = "Type of Identity Provider. Valid values are OKTA, GOOGLE, or CUSTOM."
	Audience              = "Audience for the Identity Provider."
	AuthorizationType     = "Type of authorization. Valid values are NONE, JWT, or SAML."
	ClientId              = "Client ID for the Identity Provider."
	Description           = "Description of the Identity Provider."
	DisplayName           = "Display name of the Identity Provider."
	GroupsClaim           = "Claim that Atlas uses to identify groups in the Identity Provider."
	UserClaim             = "Claim that Atlas uses to identify users in the Identity Provider."
	IssuerUri             = "URI of the Identity Provider."
	AssociatedDomains     = "List of domains associated with the Identity Provider."
	RequestedScopes       = "List of scopes that Atlas requests from the Identity Provider."
)
