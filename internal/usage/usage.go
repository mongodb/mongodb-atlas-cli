...
dbName and collection are required only for built-in roles.`
	...
	LogStart                                  = "Beginning of the date and time, in UNIX Epoch format, from which to retrieve logs. This value defaults to 24 hours prior to the current timestamp."
	LogEnd                                    = "End of the period, in UNIX Epoch format, until which to retrieve logs. This value defaults to the current timestamp."
