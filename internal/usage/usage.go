...
dbName and collection are required only for built-in roles.`
	...
	ForceDeploymentsSetup                     = "If specified, skips asking for input and creates a deployment with default settings for any options you don't specify."
	...
	SkipSampleData                            = "Indicates whether to skip loading sample data into your MongoDB cluster."
	SkipSampleDataDeployment                  = "Indicates whether to skip loading sample data into your MongoDB deployment."
	...
	StreamsInstance                           = "The name of your Atlas Stream Processing instance."
	...
	X509Type                                  = "X.509 method for authenticating the specified username.  Valid values include NONE, MANAGED, and CUSTOMER. If you set this to MANAGED or CUSTOMER, you can't set --awsIAMType or --ldapType to any value other than NONE."
	...
	DisableTableScan                          = "Disables executing any query that requires a collection scan to return results."
	EnableTableScan                           = "Enables executing any query that requires a collection scan to return results."
	DisableFailIndexKeyTooLong                = "Disables writing documents that exceed 1024 bytes without indexing."
	EnableFailIndexKeyTooLong                 = "Enables writing documents that exceed 1024 bytes without indexing."
	DisableJavascript                         = "Disables the execution of operations that perform server-side executions of JavaScript."
	EnableJavascript                          = "Enables the execution of operations that perform server-side executions of JavaScript."
