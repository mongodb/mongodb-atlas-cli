...
dbName and collection are required only for built-in roles.`
	...
	ConnectWithSetup                          = "Method for connecting to the deployment. Valid values are mongosh, compass, and skip."
	ConnectWithConnect                        = "Method for connecting to the deployment. Valid values are mongosh, compass, and connectionString."
