...
dbName and collection are required only for built-in roles.`
	...
	OIDCType              = "OIDC method by which the provided database user is authenticated. Valid values are NONE, USER, or IDP_GROUP. If you set this to USER or GROUP_ID, the user authenticates with OIDC. If you set this to USER or GROUP, you can't set --x509Type, --awsIAMType or --ldapType to any value other than NONE."
)
