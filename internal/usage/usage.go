...
dbName and collection are required only for built-in roles.`
	...
	SearchFilename                            = "Name of the JSON index configuration file to use. To learn about the format for index configuration files, see https://www.mongodb.com/docs/atlas/atlas-search/index-definitions/."
	...
	IndexName                                 = "Unique name of the index."
