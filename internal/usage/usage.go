...
dbName and collection are required only for built-in roles.`
	...
	AtlasAPIKeyDescription                    = APIKeyDescription + " Required when creatig organizations authenticated with API Keys."
	...
	AtlasAPIKeyRoles                          = APIKeyRoles + " Required when creatig organizations authenticated with API Keys."
