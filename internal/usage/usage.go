...
const (
	...
	EnableCollectDatabaseSpecificsStatistics  = "Flag that enables the IsCollectDatabaseSpecificsStatisticsEnabled field in project settings."
	DisableCollectDatabaseSpecificsStatistics = "Flag that disables the IsCollectDatabaseSpecificsStatisticsEnabled field in project settings."
	EnableDataExplorer                        = "Flag that enables the IsDataExplorerEnabled field in project settings."
	DisableDataExplorer                       = "Flag that disables the IsDataExplorerEnabled field in project settings."
	EnablePerformanceAdvisor                  = "Flag that enables the IsPerformanceAdvisorEnabled field in project settings."
	DisablePerformanceAdvisor                 = "Flag that disables the IsPerformanceAdvisorEnabled field in project settings."
	EnableSchemaAdvisor                       = "Flag that enables the IsSchemaAdvisorEnabled field in project settings."
	DisableSchemaAdvisor                      = "Flag that disables the IsSchemaAdvisorEnabled field in project settings."
	EnableRealtimePerformancePanel            = "Flag that enables the IsRealtimePerformancePanelEnabled field in project settings."
	DisableRealtimePerformancePanel           = "Flag that disables the IsRealtimePerformancePanelEnabled field in project settings."
)
