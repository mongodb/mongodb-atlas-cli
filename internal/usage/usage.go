...
dbName and collection are required only for built-in roles.`
	...
	AutoScalingMode            = "The mode in which the cluster scales. Valid values are clusterWideScaling or independentShardScaling. If not specified, the default is clusterWideScaling."
)
