...
dbName and collection are required only for built-in roles.`
	...
	ClusterFilename                               = "Path to an optional JSON configuration file that defines cluster settings. Note: Unsupported fields in the JSON file are ignored. To learn more about cluster configuration files for the Atlas CLI, see https://dochub.mongodb.org/core/cluster-config-file-atlascli."
	...
	IndexFilename                                 = "Path to an optional JSON configuration file that defines index settings. Note: Unsupported fields in the JSON file are ignored."
	...
	StreamsRegion                                 = "Human-readable label that identifies the physical location of your Atlas Stream Processing instance. The region can affect network latency and performance if it is far from your source or sink. For AWS, region name must be in the following format: VIRGINIA_USA. For a list of valid values, see https://dochub.mongodb.org/core/asp-aws-regions. For Azure, region name must be in the following format: eastus. For a list of valid values, see https://dochub.mongodb.org/core/asp-azure-regions. For GCP, region name must be in the following format: us-central1. For a list of valid values, see https://dochub.mongodb.org/core/asp-gcp-regions."
	...
	RequiredRole                                  = "To use this command, you must authenticate with a user account, a service account, or an API key with the %s role."
	RequiredOneOfRoles                            = "To use this command, you must authenticate with a user account, a service account, or an API key with any of the following roles: %s."
	...
	DataFederationFile                            = "Path to an optional JSON configuration file that defines data federation settings. Note: Unsupported fields in the JSON file are ignored. To learn more about data federation configuration files for the Atlas CLI, see https://dochub.mongodb.org/core/atlas-cli-json-data-federation-config."
	BackupCompliancePolicyFile                    = "Path to a JSON configuration file that defines backup compliance policy settings. Note: Unsupported fields in the JSON file are ignored."
	...
	OnlineArchiveFilename                         = "Path to an optional JSON configuration file that defines online archive settings. Note: Unsupported fields in the JSON file are ignored. To learn more about online archive configuration files for the Atlas CLI, see https://dochub.mongodb.org/core/atlas-cli-json-online-archive-config."
	...
	ProjectConfigFilename      = "Path to the JSON configuration file that defines project configuration settings. Note: Unsupported fields in the JSON file are ignored. To learn more about project configuration files for the Atlas CLI, see https://dochub.mongodb.org/core/project-config-file."
