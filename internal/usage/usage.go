...
dbName and collection are only required for built-in roles.`
	...
	OrgRole                                   = "User's roles  for the associated organization. To learn which values the Atlas CLI accepts, see the Items Enum for roles in the API spec: https://www.mongodb.com/docs/atlas/reference/api-resources-spec/#operation/inviteOneMongoDBUserToJoinOneAtlasOrganization/."
	ProjectRole                               = "User's roles  for the associated project. To learn which values the Atlas CLI accepts, see the Items Enum for roles in the API spec: https://www.mongodb.com/docs/atlas/reference/api-resources-spec/#operation/inviteOneMongoDBCloudUserToJoinOneProject/."
	MCLIOrgRole                               = "User's roles  for the associated organization. To learn which values MCLI accepts, see the Items Enum for roles in the Atlas API spec: https://www.mongodb.com/docs/atlas/reference/api-resources-spec/#operation/inviteOneMongoDBUserToJoinOneAtlasOrganization/."
