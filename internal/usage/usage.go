...
dbName and collection are required only for built-in roles.`
	...
	OperatorIncludeSecrets                    = "Flag that generates kubernetes secrets with data for projects, users, deployments entities." //nolint:gosec //This is just a message, not a credential
	...
	OperatorWatchNamespace                    = "List that containes namespaces that the operator will listen to."
