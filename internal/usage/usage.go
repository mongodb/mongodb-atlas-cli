...
const (
	...
	NetworkAccessListIPEntry                 = "IP address to be allowed to access the deployment. Set to 0.0.0.0/0 if you want to enable connection from anywhere; use comma(,) to separate multiple entries."
