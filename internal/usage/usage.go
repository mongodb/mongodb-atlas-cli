...
dbName and collection are required only for built-in roles.`
	...
	RequiredRole                                  = "To use this command, you must authenticate with a user account, service account or an API key with the %s role."
	RequiredOneOfRoles                            = "To use this command, you must authenticate with a user account, service account or an API key with any of the following roles: %s."
