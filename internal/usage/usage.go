...
const (
	...
	NoDefaultAlertSettings          = "Only for Atlas projects. Flag that indicates whether to create the new project with the default alert settings enabled. This flag defaults to false."
