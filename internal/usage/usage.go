...
dbName and collection are only required for built-in roles.`
	...
	OrgRole                                   = "User's roles  for the associated organization. Valid values are ORG_MEMBER, ORG_READ_ONLY, ORG_BILLING_ADMIN, ORG_GROUP_CREATOR, and ORG_OWNER."
	ProjectRole                               = "User's roles  for the associated project. Valid Atlas CLI values are GROUP_OWNER, GROUP_READ_ONLY, GROUP_USER_ADMIN, GROUP_BILLING_ADMIN, GROUP_DATA_ACCESS_ADMIN, GROUP_DATA_ACCESS_READ_ONLY, GROUP_DATA_ACCESS_READ_WRITE, GROUP_CHARTS_ADMIN, and GROUP_CLUSTER_MANAGER. Valid MCLI values are all Atlas CLI values and GROUP_AUTOMATION_ADMIN, GROUP_BACKUP_ADMIN, GROUP_MONITORING_ADMIN."
