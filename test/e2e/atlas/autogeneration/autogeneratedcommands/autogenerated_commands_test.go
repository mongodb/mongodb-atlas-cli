...
func TestAutogeneratedCommands(t *testing.T) {
	...
	t.Run("getGroupCluster_RequiredFieldNotSet", func(_ *testing.T) {
		cmd := exec.CommandContext(context.Background(), cliPath, "api", "clusters", "getGroupCluster", "-P", internal.ProfileName())
		cmd.Env = os.Environ()
	...
	t.Run("getGroupCluster_OK", func(_ *testing.T) {
		cmd := exec.CommandContext(context.Background(), cliPath, "api", "clusters", "getGroupCluster", "--groupId", g.ProjectID, "--clusterName", g.ClusterName, "-P", internal.ProfileName())
		cmd.Env = os.Environ()
	...
	t.Run("getGroupCluster_valid_version_OK", func(_ *testing.T) {
		cmd := exec.CommandContext(context.Background(), cliPath, "api", "clusters", "getGroupCluster", "--groupId", g.ProjectID, "--clusterName", g.ClusterName, "--version", "2024-08-05", "-P", internal.ProfileName())
		cmd.Env = os.Environ()
		stdOut, stdErr, err := internal.RunAndGetSeparateStdOutAndErr(cmd)
	...
	t.Run("getGroupCluster_valid_version_OK_using_projectID_alias", func(_ *testing.T) {
		cmd := exec.CommandContext(context.Background(), cliPath, "api", "clusters", "getGroupCluster", "--projectId", g.ProjectID, "--clusterName", g.ClusterName, "--version", "2024-08-05", "-P", internal.ProfileName())
		cmd.Env = os.Environ()
		stdOut, stdErr, err := internal.RunAndGetSeparateStdOutAndErr(cmd)
	...
	t.Run("getGroupCluster_invalid_version_warn", func(_ *testing.T) {
		cmd := exec.CommandContext(context.Background(), cliPath, "api", "clusters", "getGroupCluster", "--groupId", g.ProjectID, "--clusterName", g.ClusterName, "--version", "2020-01-01", "-P", internal.ProfileName())
		cmd.Env = os.Environ()
		stdOut, stdErr, err := internal.RunAndGetSeparateStdOutAndErr(cmd)
