...
**NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.`,
			...
			`roleId`: {
				Usage: `Unique 24-hexadecimal digit string that identifies the role. Amazon Web Services (AWS) IAM roles and Google Service Accounts return this value as ` + "`" + `roleId` + "`" + `. Azure Service Principals return it as ` + "`" + `_id` + "`" + `.`,
			},
		},
		Examples: nil,
	},
...
**NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.`,
	...
	`createGroupClusterOverloadSimulation`: {
		Parameters: map[string]metadatatypes.ParameterMetadata{
			`clusterName`: {
				Usage: `Human-readable label that identifies the cluster on which to start the overload protection simulation.`,
			},
			`envelope`: {
				Usage: `Flag that indicates whether Application wraps the response in an ` + "`" + `envelope` + "`" + ` JSON object. Some API clients cannot access the HTTP response headers or status code. To remediate this, set envelope=true in the query. Endpoints that return a list of results use the results object as an envelope. Application adds the status parameter to the response body.`,
			},
...
**NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.`,
	...
	`deleteGroupClusterOverloadSimulation`: {
		Parameters: map[string]metadatatypes.ParameterMetadata{
			`clusterName`: {
				Usage: `Human-readable label that identifies the cluster on which the overload protection simulation is running.`,
			},
			`envelope`: {
				Usage: `Flag that indicates whether Application wraps the response in an ` + "`" + `envelope` + "`" + ` JSON object. Some API clients cannot access the HTTP response headers or status code. To remediate this, set envelope=true in the query. Endpoints that return a list of results use the results object as an envelope. Application adds the status parameter to the response body.`,
			},
...
**NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.`,
			...
			`simulationId`: {
				Usage: `Unique 24-hexadecimal digit string that identifies the overload protection simulation.`,
			},
		},
		Examples: map[string][]metadatatypes.Example{
			`2025-03-12`: {{
...
**NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.`,
			...
			`metricIntegrationId`: {
				Usage: `Unique identifier of the metric integration configuration.`,
			},
			`pretty`: {
				Usage: `Flag that indicates whether the response body should be in the prettyprint format.`,
			},
...
**NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.`,
	...
	`getDefaultGroupLimit`: {
		Parameters: map[string]metadatatypes.ParameterMetadata{
			`envelope`: {
				Usage: `Flag that indicates whether Application wraps the response in an ` + "`" + `envelope` + "`" + ` JSON object. Some API clients cannot access the HTTP response headers or status code. To remediate this, set envelope=true in the query. Endpoints that return a list of results use the results object as an envelope. Application adds the status parameter to the response body.`,
			},
			`limitName`: {
				Usage: `Identifies the user-managed limit.`,
			},
			`pretty`: {
				Usage: `Flag that indicates whether the response body should be in the prettyprint format.`,
			},
...
**NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.`,
	...
	`getGroupAiModelApiCloudGeographyModelGroupNameRateLimits`: {
		Parameters: map[string]metadatatypes.ParameterMetadata{
			`cloud`: {
				Usage: `Cloud provider scope. Must be "ANY". Additional values will be supported in future API versions.`,
			},
			`envelope`: {
				Usage: `Flag that indicates whether Application wraps the response in an ` + "`" + `envelope` + "`" + ` JSON object. Some API clients cannot access the HTTP response headers or status code. To remediate this, set envelope=true in the query. Endpoints that return a list of results use the results object as an envelope. Application adds the status parameter to the response body.`,
			},
			`geography`: {
				Usage: `Geography scope. Must be "ANY". Additional values will be supported in future API versions.`,
			},
			`groupId`: {
				Usage: `Unique 24-hexadecimal digit string that identifies your project. Use the [/groups](#tag/Projects/operation/listProjects) endpoint to retrieve all projects to which the authenticated user has access.
...
**NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.`,
			...
			`jobId`: {
				Usage: `Unique 24-hexadecimal digit string that identifies the collection restore job to return.`,
			},
			`pretty`: {
				Usage: `Flag that indicates whether the response body should be in the prettyprint format.`,
			},
...
**NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.`,
			...
			`jobId`: {
				Usage: `Unique 24-hexadecimal digit string that identifies the collection restore job.`,
			},
			`pretty`: {
				Usage: `Flag that indicates whether the response body should be in the prettyprint format.`,
			},
			`sourceNamespace`: {
				Usage: `Source namespace that identifies the collection to return (e.g. ` + "`" + `db.collection` + "`" + `).`,
			},
		},
		Examples: map[string][]metadatatypes.Example{
			`2025-03-12`: {{
...
**NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.`,
	...
	`getGroupClusterOverloadSimulation`: {
		Parameters: map[string]metadatatypes.ParameterMetadata{
			`clusterName`: {
				Usage: `Human-readable label that identifies the cluster on which the overload protection simulation is running.`,
			},
...
**IMPORTANT**: The complete list of event type values changes frequently.`,
	...
	`getOrgAiModelApiCloudGeographyModelGroupNameRateLimits`: {
		Parameters: map[string]metadatatypes.ParameterMetadata{
			`cloud`: {
				Usage: `Cloud provider scope. Must be "ANY". Additional values will be supported in future API versions.`,
			},
	...
	`getOrgInvoiceReport`: {
		Parameters: map[string]metadatatypes.ParameterMetadata{
			`invoiceId`: {
				Usage: `Unique string that identifies the invoice the report was generated for.`,
			},
			`orgId`: {
				Usage: `Unique 24-hexadecimal digit string that identifies the organization that contains your projects. Use the [` + "`" + `/orgs` + "`" + `](#tag/Organizations/operation/listOrganizations) endpoint to retrieve all organizations to which the authenticated user has access.`,
			},
			`reportId`: {
				Usage: `Unique string that identifies the report to retrieve.`,
			},
		},
		Examples: map[string][]metadatatypes.Example{
			`2025-03-12`: {{
...
**NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.`,
	...
	`inspectGroupStandbyLinkFailoverReadiness`: {
		OnlyPrivatePreview: true,
		Parameters: map[string]metadatatypes.ParameterMetadata{
			`envelope`: {
				Usage: `Flag that indicates whether to wrap the response in an envelope.`,
...
**NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.`,
			...
			`oplogInc`: {
				Usage: `Oplog operation number that represents the desired point in time. This is the second part of an Oplog timestamp. Must be used with ` + "`" + `oplogTs` + "`" + `. Mutually exclusive with ` + "`" + `pointInTimeUtcSeconds` + "`" + `.`,
			},
			`oplogTs`: {
				Usage: `Oplog timestamp that represents the desired point in time. This is the first part of an Oplog timestamp. Must be used with ` + "`" + `oplogInc` + "`" + `. Mutually exclusive with ` + "`" + `pointInTimeUtcSeconds` + "`" + `.`,
			},
			`pageNum`: {
				Usage: `Number of the page that displays the current set of the total objects that the response returns.`,
			},
			`pointInTimeUtcSeconds`: {
				Usage: `Desired point in time, expressed as the number of seconds that have elapsed since the UNIX epoch. If specified, returns the closest snapshot created before that point in time. Mutually exclusive with ` + "`" + `oplogTs` + "`" + ` and ` + "`" + `oplogInc` + "`" + `.`,
			},
			`pretty`: {
				Usage: `Flag that indicates whether the response body should be in the prettyprint format.`,
			},
...
**NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.`,
			...
			`sourceNamespace`: {
				Usage: `Source namespace to filter by (e.g. ` + "`" + `db.collection` + "`" + `).`,
			},
			`state`: {
				Usage: `Collection-level state to filter by.`,
			},
			`targetNamespace`: {
				Usage: `Target namespace to filter by (e.g. ` + "`" + `db.collection` + "`" + `).`,
			},
		},
		Examples: map[string][]metadatatypes.Example{
			`2025-03-12`: {{
...
**NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.`,
	...
	`listGroupClusterOverloadSimulations`: {
		Parameters: map[string]metadatatypes.ParameterMetadata{
			`clusterName`: {
				Usage: `Human-readable label that identifies the cluster on which the overload protection simulations are running.`,
			},
			`envelope`: {
				Usage: `Flag that indicates whether Application wraps the response in an ` + "`" + `envelope` + "`" + ` JSON object. Some API clients cannot access the HTTP response headers or status code. To remediate this, set envelope=true in the query. Endpoints that return a list of results use the results object as an envelope. Application adds the status parameter to the response body.`,
			},
...
**NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.`,
			...
			`providerType`: {
				Usage: `Optional filter by provider type (e.g., ` + "`" + `CUSTOM` + "`" + `). When specified, ` + "`" + `integrationType` + "`" + ` must also be specified.`,
			},
		},
		Examples: map[string][]metadatatypes.Example{
			`preview`: {{
...
**NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.`,
			...
			`modelGroupName`: {
				Usage: `The name of the model group to be reset to default rate limits.`,
			},
			`pretty`: {
				Usage: `Flag that indicates whether the response body should be in the prettyprint format.`,
			},
...
**NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.`,
	...
	`updateGroupClusterSqlInterface`: {
		OnlyPrivatePreview: true,
		Parameters: map[string]metadatatypes.ParameterMetadata{
			`clusterName`: {
				Usage: `Human-readable label that identifies the cluster.`,
...
**NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.`,
	...
	`updateGroupPrivateEndpointEndpointService`: {
		Parameters: map[string]metadatatypes.ParameterMetadata{
			`endpointServiceId`: {
				Usage: `Unique 24-hexadecimal digit string that identifies the private endpoint service that you want to update.`,
			},
			`envelope`: {
				Usage: `Flag that indicates whether Application wraps the response in an ` + "`" + `envelope` + "`" + ` JSON object. Some API clients cannot access the HTTP response headers or status code. To remediate this, set envelope=true in the query. Endpoints that return a list of results use the results object as an envelope. Application adds the status parameter to the response body.`,
			},
...
**NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.`,
	...
	`updateGroupStreamPrivateLinkConnection`: {
		Parameters: map[string]metadatatypes.ParameterMetadata{
			`connectionId`: {
				Usage: `Unique ID that identifies the Private Link connection.`,
			},
