...
func markExperimenalToAPICommands(cmd *cobra.Command) {
	cmd.Short = "`Public Preview: please provide feedback at https://feedback.mongodb.com/forums/930808-atlas-cli, see more at <https://www.mongodb.com/docs/atlas/cli/current/command/atlas-api/>`_: " + cmd.Short
}
