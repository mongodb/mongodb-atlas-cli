...
func generateFile(name, version string) error {
	...
	downloadArchive := &DownloadArchive{
		...
		Platform: []*Platform{
			...
			newPlatform(version, "x86_64", "linux", "Red Hat + CentOS 8, 9 / SUSE 15 / Amazon Linux 2023 (x86_64)", []string{"rpm"}),
			newPlatform(version, "arm64", "linux", "Red Hat + CentOS 8, 9 / SUSE 15 / Amazon Linux 2023 (arm64)", []string{"rpm"}),
