...
func generateFile(name, version string) error {
	...
	downloadArchive := &DownloadArchive{
		...
		Platform: []Platform{
			...
			*newPlatform(version, "x86_64", "linux", "Debian 10, 11, 12 / Ubuntu 20.04, 22.04 (x86_64)", []string{"deb"}),
			*newPlatform(version, "arm64", "linux", "Debian 10, 11, 12 / Ubuntu 20.04, 22.04 (arm64)", []string{"deb"}),
